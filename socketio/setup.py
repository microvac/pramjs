...
setup(name='pramjs.socketio',
      version='0.8',
      url='http://pypi.python.org/pypi/pramjs.socketio',
      license='MIT',
      description='Wrapper for socketio',
      ...
      entry_points="""
          # -*- Entry points: -*-
          [prambanan.library]
          pramjs.socketio = pramjs.socketio.pramlib:PrambananLibrary
          """,
      packages = ['pramjs', 'pramjs.socketio'],
      **extra)
