...
setup(name='pramjs.elquery',
      version='0.8',
      url='http://pypi.python.org/pypi/pramjs.elquery',
      license='MIT',
      description='Wrapper for jQuery',
      ...
      entry_points="""
          # -*- Entry points: -*-
          [prambanan.library]
          pramjs.elquery = pramjs.elquery.pramlib:PrambananLibrary
          """,
      packages = ['pramjs', 'pramjs.elquery'],
      **extra)
