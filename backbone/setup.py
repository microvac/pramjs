...
setup(name='pramjs.backbone',
      version='0.8',
      url='http://pypi.python.org/pypi/pramjs.backbone',
      license='MIT',
      description='Wrapper for backbone.js',
      ...
      # -*- Entry points: -*-
      [prambanan.library]
      pramjs.backbone = pramjs.backbone.pramlib:PrambananLibrary
      """,
      packages = ['pramjs', 'pramjs.backbone'],
      **extra)
