...
setup(name='pramjs.qq',
      version='0.8',
      url='http://pypi.python.org/pypi/pramjs.qq',
      license='MIT',
      description='Wrapper for fileuploader.js',
      ...
      # -*- Entry points: -*-
      [prambanan.library]
      pramjs.qq = pramjs.qq.pramlib:PrambananLibrary
      """,
      packages = ['pramjs', 'pramjs.qq'],
      **extra)
